...
$string['sync_scope_useradderror'] = 'Skipping the user with username "{$a}" who is new in LDAP. The username does not have the configured scope or is empty after stripping the scope. We will ignore it.';
